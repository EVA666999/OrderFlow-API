...
- Развернул в облаке(VPS): настроил ssl-сертификат, базу данных и подключил домен.
- Реализована аутентификация через Яндекс (OAuth2)
- Подключил систему оплат Youmoney
- CI/CD
